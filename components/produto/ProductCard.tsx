    ...
    <Link href={`/produto/${produto.id}`} className="group block bg-white rounded-2xl shadow-[var(--shadow-card)] hover:shadow-[var(--shadow-card-hover)] transition-all duration-300 hover:-translate-y-1 overflow-hidden">
      <div className="relative aspect-square overflow-hidden bg-section">
        ...
        {produto.personalizado && (
          <span className="absolute top-3 left-3 bg-[#F4845F] text-white text-[10px] font-bold px-2 py-1 rounded-xl uppercase tracking-wider shadow-sm z-10">
            Personalizado
          </span>
        )}
      </div>
      <div className="p-5 flex flex-col gap-2">
        ...
        <div className="mt-4 pt-4">
          <div className="flex items-center justify-center text-[#ffffff] border border-[#F4845F] bg-primary rounded-xl py-2 hover:bg-[#a25e47] hover:text-white transition-colors text-sm font-medium">
            Comprar
          </div>
        </div>
      </div>
